"""
Django settings for grocery_bot project.
...
SECRET_KEY = "django-insecure-73$qixbm6*dy_9=y5n7^gp3^q5rrp1go&)3o$zz+=*tsbvk%ud"
...
WSGI_APPLICATION = "grocery_bot.wsgi.application"
